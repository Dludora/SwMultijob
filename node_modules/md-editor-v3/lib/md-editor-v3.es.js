...
const useKeyBoard = (props2, context) => {
  const { editorId, noPrettier } = props2;
  const initFunc = (name) => {
    var _a, _b;
    return ((_a = props2.toolbars) == null ? void 0 : _a.includes(name)) && !((_b = props2.toolbarsExclude) == null ? void 0 : _b.includes(name)) && !noPrettier;
  };
...
const useProvide = (props2, extension) => {
  var _a;
  const { editorId } = props2;
  const highlightConfig = (_a = extension == null ? void 0 : extension.editorExtensions) == null ? void 0 : _a.highlight;
  ...
  provide("highlight", computed(() => {
    ...
    return {
      ...
      css: cssList[props2.codeTheme] ? cssList[props2.codeTheme][props2.theme] : codeCss.atom[props2.theme]
    };
  }));
  ...
  const usedLanguageText = computed(() => {
    var _a2;
    const allText = __spreadValues(__spreadValues({}, staticTextDefault), (_a2 = extension == null ? void 0 : extension.editorConfig) == null ? void 0 : _a2.languageUserDefined);
...
const useExpansion = (props2, extension) => {
  const {
    noPrettier,
    previewOnly
  } = props2;
  onMounted(() => {
    ...
    iconfontScript.src = ((_a = extension.editorExtensions) == null ? void 0 : _a.iconfont) || iconfontUrl;
    iconfontScript.id = `${prefix}-icon`;
    const prettierScript = document.createElement("script");
    const prettierMDScript = document.createElement("script");
    prettierScript.src = ((_c = (_b = extension.editorExtensions) == null ? void 0 : _b.prettier) == null ? void 0 : _c.parserMarkdownJs) || prettierUrl.main;
    prettierScript.id = `${prefix}-prettier`;
    prettierMDScript.src = ((_e = (_d = extension.editorExtensions) == null ? void 0 : _d.prettier) == null ? void 0 : _e.parserMarkdownJs) || prettierUrl.markdown;
    prettierMDScript.id = `${prefix}-prettierMD`;
    const cropperLink = document.createElement("link");
    cropperLink.rel = "stylesheet";
    cropperLink.href = ((_g = (_f = extension.editorExtensions) == null ? void 0 : _f.cropper) == null ? void 0 : _g.css) || cropperUrl.css;
    cropperLink.id = `${prefix}-cropperCss`;
    const cropperScript = document.createElement("script");
    cropperScript.src = ((_i = (_h = extension.editorExtensions) == null ? void 0 : _h.cropper) == null ? void 0 : _i.js) || cropperUrl.js;
    cropperScript.id = `${prefix}-cropper`;
    if (!previewOnly) {
      appendHandler(iconfontScript);
      if (!((_k = (_j = extension.editorExtensions) == null ? void 0 : _j.cropper) == null ? void 0 : _k.instance)) {
...
const useConfig = (props2, context) => {
  const { editorId } = props2;
...
var ClipModal = defineComponent({
  ...
  setup(props2) {
    ...
    let Cropper = (_b = (_a = extension == null ? void 0 : extension.editorExtensions) == null ? void 0 : _a.cropper) == null ? void 0 : _b.instance;
    const uploadRef = ref();
...
const useSreenfull = (props2) => {
  ...
  const extension = inject("extension");
  let screenfull = (_b = (_a = extension.editorExtensions) == null ? void 0 : _a.screenfull) == null ? void 0 : _b.instance;
  const screenfullJs = (_d = (_c = extension.editorExtensions) == null ? void 0 : _c.screenfull) == null ? void 0 : _d.js;
...
const directive2flag = (direct, selectedText = "", inputArea, params) => {
  ...
  let prefixVal;
  let subfixVal;
  const mermaidTemplate = params == null ? void 0 : params.mermaidTemplate;
...
const useHistory = (props2, textAreaRef, completeStatus) => {
  var _a, _b;
  const previewOnly = inject("previewOnly");
  ...
  watch([toRef(props2, "value"), completeStatus], () => {
    if (completeStatus.value) {
      saveHistory(props2.value);
    }
  });
  onMounted(() => {
    bus.on(editorId, {
...
const useMarked = (props2, mermaidData) => {
  ...
  renderer.heading = (text, level, raw, slugger) => {
    ...
    const id = props2.markedHeadingId(raw, level, heads.value.length);
    if (text !== raw) {
      return `<h${level} id="${id}">${text}</h${level}>`;
    } else {
  ...
  const html = ref(props2.sanitize(marked(props2.value || "", { renderer })));
  const markHtml = debounce(() => {
    heads.value = [];
    const _html = props2.sanitize(marked(props2.value || "", { renderer }));
    html.value = _html;
    props2.onHtmlChanged(_html);
  }, (editorConfig == null ? void 0 : editorConfig.renderDelay) !== void 0 ? editorConfig == null ? void 0 : editorConfig.renderDelay : 500);
  watch([
    highlightInited,
...
const useAutoScroll = (props2, html, textAreaRef, previewRef, htmlRef) => {
  ...
  const htmlChanged = () => {
    nextTick(() => {
      if (props2.setting.preview && !previewOnly && props2.scrollAuto) {
        clearScrollAuto();
        initScrollAuto();
      }
      initCopyEntry();
  ...
  onMounted(() => {
    initCopyEntry();
    if (!previewOnly && props2.scrollAuto && (previewRef.value || htmlRef.value)) {
      [initScrollAuto, clearScrollAuto] = scrollAuto(textAreaRef.value, previewRef.value || htmlRef.value);
    }
  });
};
      ...
      bus.on(editorId, {
        ...
        callback(direct, params = {}) {
          props2.onChange(directive2flag(direct, selectedText.value, textAreaRef.value, __spreadProps(__spreadValues({}, params), {
            tabWidth,
            mermaidTemplate: props2.mermaidTemplate,
            editorId
          })));
        }
      });
...
const useMermaid = (props2) => {
  ...
  const { editorExtensions } = inject("extension");
  ...
  let mermaidScript;
  onMounted(() => {
    if (!props2.noMermaid && !(mermaidConf == null ? void 0 : mermaidConf.instance)) {
...
var Content = defineComponent({
  ...
  setup(props2) {
    ...
    useHistory(props2, textAreaRef, completeStatus);
...
var MarkdownTotal = defineComponent({
  ...
  setup(props2) {
    ...
    return () => {
      ...
      }, [(_a = ult.value.footer) == null ? void 0 : _a.markdownTotal, createTextVNode(":")]), createVNode("span", null, [props2.modelValue.length])]);
    };
  }
});
var style$1 = "";
...
const Editor = defineComponent({
  ...
  setup(props2, context) {
    ...
    useProvide(props2, extension);
    useExpansion(props2, extension);
    const [setting, updateSetting] = useConfig(props2, context);
    const [catalogVisible, catalogShow] = useCatalog(props2);
    onBeforeUnmount(() => {
      bus.clear(editorId);
    });
    return () => {
      ...
      return createVNode("div", {
        "id": editorId,
        "class": [prefix, props2.class, props2.theme === "dark" && `${prefix}-dark`, setting.fullscreen || setting.pageFullScreen ? `${prefix}-fullscreen` : "", props2.previewOnly && `${prefix}-previewOnly`],
        "style": props2.style
      }, [!props2.previewOnly && createVNode(ToolBar, {
        "noPrettier": props2.noPrettier,
        ...
        "mermaidTemplate": (_a = extension == null ? void 0 : extension.editorConfig) == null ? void 0 : _a.mermaidTemplate,
        "scrollAuto": state.scrollAuto
      }, null), !props2.previewOnly && ((_b = props2.footers) == null ? void 0 : _b.length) > 0 && createVNode(Footer, {
        "modelValue": props2.modelValue,
